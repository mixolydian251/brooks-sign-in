...
class CustomerForm extends React.Component {
    ...
    SubmitCustomer = (e) => {
        ...
        if (this.state.name &&
            ...
            (!this.state.phoneNumber || this.state.phoneNumber.match(/\(?([0-9]{3})\)?([ .-]?)([0-9]{3})\2([0-9]{4})/))
        ){
        ...
        return (
            <div>
                <form className="form_container" onSubmit={this.SubmitCustomer}>
                    <div className="form_item"><div className="form_label">Name:</div>
                        <input
                            autoFocus
                    ...
                    <div className="form_item"><div className="form_label">Age:</div>
                        <input
                            className="form_text_bar"
                            type="number"
                            placeholder="Age"
                    ...
                    <div className="form_item"><div className="form_label">Address:</div>
                        <input
                            className="form_text_bar"
                            type="text"
                            placeholder="Address"
                    ...
                    <div className="form_item"><div className="form_label">City:</div>
                        <input
                            className="form_text_bar"
                            type="text"
                            placeholder="City"
                    ...
                    <div className="form_item"><div className="form_label">State:</div>
                        <input
                            className="form_text_bar"
                            type="text"
                            placeholder="State"
                    ...
                    <div className="form_item"><div className="form_label">Phone Number:</div>
                        <input
                            className="form_text_bar"
                            type="text"
                    ...
                    <div className="form_item"><div className="form_label">Dependants:</div></div>

                    {this.state.dependants && <div className="dependant">
                        {this.state.dependants.map((dependant) => {
                            return <DependantFormItem dependant={dependant}
                                                      key={dependant.id}
                    ...
                    {this.state.error && <h4 className="error">Fill out the following fields to submit. ( Name, Age, Address )</h4>}

                    <div className="button_layout">
                        <button className="sign_in_button" type="submit">Save Customer</button>
